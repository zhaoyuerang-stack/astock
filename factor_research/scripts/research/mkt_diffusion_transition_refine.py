...
Usage:
  /usr/bin/python3 -m scripts.research.mkt_diffusion_transition_refine
"""
import json
import os
import sys
...
from scripts.research.state_transition_signal_search import rolling_percentile  # noqa: E402
