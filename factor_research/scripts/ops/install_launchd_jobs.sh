...
mkdir -p "$AGENTS"
mkdir -p "$ROOT/logs/daily_update" "$ROOT/logs/weekly_maintenance" "$ROOT/logs/api" "$ROOT/logs/web"
mkdir -p "$ROOT/reports/ops/daily_update" "$ROOT/reports/ops/weekly_maintenance"

for job in com.astcok.daily-update com.astcok.weekly-maintenance com.astcok.api com.astcok.web; do
