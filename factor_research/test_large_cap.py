"""Sanity check for the new Large-cap Growth Hedged strategy implementation."""
import os
import sys
...
from strategies.large_cap import StrategyConfig, run_large_cap_strategy, latest_signal

def main():
    print("=" * 60)
    print("Testing Large-cap Strategy Integration...")
    print("=" * 60)

    # 1. Test running backtest (OOS 2023-2026)
    print("\n[1/3] Running OOS backtest...")
    config = StrategyConfig(start="2023-01-01", ma_window=120, buffer_size=0.01)
