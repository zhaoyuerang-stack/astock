...
SOURCE_REGISTRY: dict[str, SourceSpec] = {
    ...
    "global_fmp_fx_v1": SourceSpec(
        source_id="global_fmp_fx_v1",
        provider="openbb",
        adapter="lake.sources.openbb_global.OpenBBGlobalProvider",
        endpoint="openbb.currency.price.historical(provider=fmp)",
        owner="data-infrastructure",
        admission_status="planned",
        allowed_use="research_only",
        license_status="pending",
        ...
        currency="PAIR",
        units="provider_ohlcv",
        raw_schema_version="openbb-fmp-fx-v1",
        canonical_schema_version="global-price-v1",
        primary_key_policy="symbol_exchange_session_date_adjustment_version",
        dedupe_policy="identical_key_rows_dedup_conflicts_reject_batch",
        observed_field="session_date",
    ...
    "alpha_vantage_commodity_spot_v1": SourceSpec(
        source_id="alpha_vantage_commodity_spot_v1",
        provider="alphavantage",
        adapter="lake.sources.alpha_vantage_commodity.AlphaVantageCommodityProvider",
        ...
        datasets=("commodity_daily",),
        allowlist=("CL=F", "BZ=F", "NG=F", "GC=F", "SI=F"),
        dataset_allowlists=(("commodity_daily", ("CL=F", "BZ=F", "NG=F", "GC=F", "SI=F")),),
        calendar="GLOBAL_COMMODITY_SPOT",
        timezone="UTC",
        currency="USD",
        units="spot_close_only",
        raw_schema_version="alphavantage-commodity-spot-v1",
        canonical_schema_version="global-price-v1",
        primary_key_policy="symbol_exchange_session_date_adjustment_version",
        dedupe_policy="identical_key_rows_dedup_conflicts_reject_batch",
        observed_field="session_date",
        ...
        retrieved_field="retrieved_at",
        revision_policy="provider_history_may_revise",
        corporate_action_policy="spot_series_not_futures_chain",
    ),
    "fred_commodity_spot_v1": SourceSpec(
        source_id="fred_commodity_spot_v1",
        provider="fredcommodity",
        adapter="lake.sources.fred_commodity.FredCommodityProvider",
        endpoint="https://api.stlouisfed.org/fred/series/observations",
        owner="data-infrastructure",
        admission_status="planned",
        allowed_use="research_only",
        ...
        api_key_env="FRED_API_KEY",
        datasets=("commodity_daily",),
        allowlist=("CL=F", "BZ=F", "NG=F"),
        dataset_allowlists=(("commodity_daily", ("CL=F", "BZ=F", "NG=F")),),
        calendar="US_ENERGY_SPOT",
        timezone="UTC",
        currency="USD",
        units="spot_close_only",
        raw_schema_version="fred-commodity-spot-v1",
        canonical_schema_version="global-price-v1",
        primary_key_policy="symbol_exchange_session_date_adjustment_version",
        dedupe_policy="identical_key_rows_dedup_conflicts_reject_batch",
        observed_field="session_date",
