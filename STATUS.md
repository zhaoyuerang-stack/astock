...
## 一句话
阶段 0 已关闭。**2026-06-06**: v2.2(PureTrend tw=2)发现偷看bug(缺shift(1),T日仓位用T日收益),修复后年化仅2.2%→已退役。同日注册第2个母策略 `size-earnings/v1.0`(小盘+盈利增长+VolTarget,WF验证通过)。当前生产基线仍为 v2.0。
...
- `small-cap-size / v2.0`(**当前生产基线**):MA16 择时 — IS 年化 22.2% / 回撤 -20.0% / 夏普 1.38;真实盘 T+1 预期 17.5% / 夏普 1.19。
- `size-earnings / v1.0`(2026-06-06,**第2个母策略**):0.5×size60 + 0.5×NPY + PureTrend + VolTarget(25%/60d) + Lev1.10 — IS 15.1% / -18.3% / 夏普 1.05 ✅入册;WF OOS(2022-2025) 19.0% / -19.5% / 夏普 1.16。
- ~~v2.2(PureTrend tw=2)~~ → **退役**:缺 shift(1) 导致偷看,修复后年化仅 2.2%。
