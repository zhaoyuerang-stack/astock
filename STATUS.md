...
## 一句话
阶段 0 已关闭。**2026-06-06**:发现 v2.2 偷看 bug→退役;注册 size-earnings v1.0(第2个母策略);建立 workflow 自动化发现流水线(Phase1-4);并行探索 18 候选发现 **illiquidity v1.0** 全面超越 v2.0 → 成为新生产基线。
...
- `illiquidity / v1.0`(2026-06-06,**当前生产基线**):Amihud 非流动性 + PureTrend MA16 — IS 年化 32.3% / 回撤 -15.4% / 夏普 1.78;真实盘 T+1 20.0% / -13.4% / 夏普 1.30。WF +35.6%/10/12正。18候选并行探索唯一全流程通过者。全面超越 v2.0。
- `size-earnings / v1.0`:0.5×size60 + 0.5×NPY + PureTrend + VolTarget + Lev1.10 — IS 15.1% / -18.3% / 夏普 1.05;WF +19.0% / -19.5%。定位:低回撤补充策略。
- `small-cap-size / v2.0`→ **参考**(已被 illiquidity 超越):IS 22.2% / -20.0% / 真实盘 17.5%。
- ~~v2.2(PureTrend tw=2)~~ → **退役**:缺 shift(1) 偷看。
